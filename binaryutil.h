...
/**
 * Convert a 32 bit integer to it's binary character representation.
 * 
 * Result points to an array to hold 32 characters.
 */
extern void int_to_binary(uint32_t to_convert, char * result);